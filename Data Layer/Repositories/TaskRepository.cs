...
namespace TriadInterviewBackend.DataLayer.Repositories
{
    public class TaskRepository : ITaskRepository
    {
        ...
        public async Task<bool> UpdateTaskAsync(ProjectTask taskToUpdate)
        {
            ...
            task.CreatedByUserName = taskToUpdate.CreatedUserName;
            task.EdittedByUserName = taskToUpdate.EditedUserName;
        ...
        private ProjectTask EntityToDomain(TaskEntity taskEntity)
        {
            return new ProjectTask
            {
                ...
                CreatedUserName = taskEntity.CreatedByUserName,
                EditedUserName = taskEntity.EdittedByUserName
            };
        }
        ...
        private TaskEntity DomainToEntity(ProjectTask task)
        {
            return new TaskEntity
            {
                ...
                CreatedByUserName = task.CreatedUserName,
                EdittedByUserName = task.EditedUserName
            };
        }
    }
}
